# Generated by Django 4.2.19 on 2025-02-23 15:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='acheteur', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'acheteur',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acheteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commandes', to='api.acheteur')),
            ],
            options={
                'db_table': 'commande',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agriculteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='produits', to='api.agriculteur')),
            ],
            options={
                'db_table': 'produit',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acheteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avis', to='api.acheteur')),
